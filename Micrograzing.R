...
rm(list=ls())
setwd("~/AWI/RProjects/Old_scripts/SOT22_all")
...
gra <- readxl::read_excel("Data/GrazingRates_SOT22.xlsx")
...
one.way
# there is only a significant interaction, thus perform pairwise t-tests
